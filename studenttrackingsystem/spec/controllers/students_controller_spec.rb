...
describe StudentsController do
  ...
  let(:valid_attributes) { { "first_name" => "MyText" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested student" do
        ...
        Student.any_instance.should_receive(:update).with({ "first_name" => "MyText" })
        put :update, {:id => student.to_param, :student => { "first_name" => "MyText" }}, valid_session
      end
